    ...
    <footer v-if="!selectedSurah && !store.readingMode" class="mt-auto border-t bg-gradient-to-br from-background via-background to-primary/5">
      <div class="container mx-auto px-4 py-12">
        ...
        <div class="mb-12 max-w-md mx-auto">
          <div class="p-6 rounded-2xl bg-gradient-to-br from-primary/10 to-emerald-500/10 border-2 border-primary/20 shadow-lg">
            <div class="flex items-center gap-4">
              <div class="w-16 h-16 rounded-full overflow-hidden border-4 border-primary/30 shadow-lg flex-shrink-0">
                <img 
                  src="/logo.png" 
                  alt="صاحب المشروع"
              ...
              <div class="flex-1">
                <p class="text-xs font-arabic text-muted-foreground mb-1">المطوّر</p>
                <h3 class="font-arabic-bold text-xl text-primary mb-1">صاحب المشروع</h3>
                <p class="text-xs text-muted-foreground">GitHub Profile</p>
              </div>
              <a 
                href="https://github.com/naoufalnajim01" 
                target="_blank"
                rel="noopener noreferrer"
                class="p-3 rounded-full bg-foreground text-background hover:bg-primary hover:scale-110 transition-all shadow-md"
                title="GitHub"
              >
